        ...
        child: Column(
          children: [
            ...
            Stack(
              ...
              children: <Widget>[
                ...
                ClipRRect(
                  ...
                  child: Image.asset('assets/images/julkar.jpg', height: 120, width: 120),
                ),
              ],
            ),
            ...
            Padding(
              ...
              child: Container(
                alignment: Alignment.bottomLeft,
                child: const Text("Your smile live long",
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
          ...
          const Padding(
            ...
            Padding(
              ...
              child: Container(
                alignment: Alignment.centerLeft,
                child: const Text("Favourite Moto",
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.black,
            ...
            const Padding(
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Text("Try Hard to get your Dream",
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                      ),
                      ),
